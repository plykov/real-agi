...
> 🇬🇧 **English version:** [Eng/3_Verticals/mentoring/4_real-estate-ai-collapse.md](../../../Eng/3_Verticals/mentoring/4_real-estate-ai-collapse.md)
...
```mermaid
flowchart TB
    S1["1. Молодые не заходят в игру"] --> S2["2. Цены сползают"] --> S3["3. Инвестпортфели текут"] --> S4["4. Цепная реакция"] --> S5["5. Банки не спасают"] --> S6["6. Отскока не будет"]
```
