...
> 🇷🇺 **Russian version:** [Ru/AGI/07-pipeline-otbora-ontologij.md](../../Ru/AGI/07-pipeline-otbora-ontologij.md)
...
```mermaid
flowchart TB
    A["1. Primitives"] --> B["2. Language"] --> C["3. Metaphors"] --> D["4. Hypotheses"] --> E["5. Formal hypotheses"] --> F["6. Mathematical models"]
    F --> G["7. Experimental environment"] --> H["8. Experiment design"] --> I["9. Experiment with feedback"] --> J["10. Evaluation & correlates"] --> K["11. Strengthened control over reality"]
    K -. "recursion: any link can throw back" .-> A
```
