...
## 0. TL;DR — one core, many spheres <a id="tldr"></a>
...
## 1. The core is invariant: why professions look different <a id="1-core"></a>
...
## 2. A run through the verticals <a id="2-verticals"></a>

```mermaid
flowchart TB
    CORE["One core<br/>reality model → scenario space → positioning layer"]
    CORE --> C1["Career"]
    CORE --> C2["Business"]
    CORE --> C3["War"]
    CORE --> C4["State"]
...
## 3. Different spheres, not different intelligences <a id="3-conclusion"></a>
