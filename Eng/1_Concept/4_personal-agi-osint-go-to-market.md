...
## 0. TL;DR — whom to sell the Guardian to, and why them <a id="tldr"></a>
...
## 1. Why the top segment: they already pay for think tanks <a id="uhnw"></a>
...
## 2. "Personal AGI" and the "first dose" model <a id="first-dose"></a>
...
```mermaid
flowchart LR
    A["The 'first dose'<br/>4–8 weeks, free or nearly free<br/>a map of possible lives<br/>from open sources alone"] --> B["Annual retainer<br/>+ optional success fee<br/>on specific missions"] --> C["Retention through the difference<br/>in quality of vision<br/>exclusivity, NDA"]
```

---

## 3. No one will hand over the data: OSINT and listener agents <a id="osint"></a>
...
## 4. The illusion of secrecy versus the digital footprint <a id="illusion"></a>
...
## 5. Ethics as part of the product: consent, transparency, confidence levels <a id="ethics"></a>
...
## 6. Analysis is cartography of the future <a id="cartography"></a>
...
## 7. Bottom-up: verticals → invariants → integration <a id="bottom-up"></a>
