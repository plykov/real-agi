...
## TL;DR — the whole model on one page <a id="tldr"></a>
...
## 1. The shift: what changed since 2011 <a id="1-shift"></a>
...
## 2. The surface: a system of development <a id="2-surface"></a>
...
## 3. The depth: power as subtle soft power <a id="3-depth"></a>
...
## 4. Why audience is first: the non-computable remainder <a id="4-audience-first"></a>
...
## 5. The 2011 mistake: the state as customer <a id="5-mistake"></a>
...
## 6. The limit: meritocracy and the partnership of human and AI <a id="6-limit"></a>
...
## 7. The permeable membrane: the meritocracy trap <a id="7-membrane"></a>
...
## 8. Tensions and risks <a id="8-risks"></a>
