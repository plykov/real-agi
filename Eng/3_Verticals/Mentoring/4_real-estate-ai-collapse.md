---
title: "The End of Real Estate as an Investment"
type: article
status: draft
audience: mixed
author: Alex Krol
...
```mermaid
flowchart TB
    S1["1. The young don't enter"] --> S2["2. Prices slide"] --> S3["3. Investment portfolios leak"] --> S4["4. Chain reaction"] --> S5["5. Banks can't bail out"] --> S6["6. No rebound"]
```
